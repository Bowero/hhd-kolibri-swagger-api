...
class ErrorResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'broken_business_rules' => 'map[string,string]',
    ...
    {
        $this->container['broken_business_rules'] = isset($data['broken_business_rules']) ? $data['broken_business_rules'] : null;
     ...
     *
     * @param map[string,string] $broken_business_rules broken_business_rules
     *
     * @return $this
     */
