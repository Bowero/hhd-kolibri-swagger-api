...
/**
 * MakeVersionOfRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MakeVersionOfRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MakeVersionOfRequest';
    ...
    {
        $this->container['source_assignment_id'] = isset($data['source_assignment_id']) ? $data['source_assignment_id'] : null;
        $this->container['target_assignment_id'] = isset($data['target_assignment_id']) ? $data['target_assignment_id'] : null;
    }
