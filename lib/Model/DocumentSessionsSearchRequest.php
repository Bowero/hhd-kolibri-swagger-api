...
/**
 * DocumentSessionsSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DocumentSessionsSearchRequest extends SearchRequest 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DocumentSessionsSearchRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'order_by' => 'object',
        'term_fields' => '\Swagger\Client\Model\DocumentSessionTermField[]'
    ];
     ...
     * Sets parent_id
     *
     * @param string $parent_id Search by a specific parent (ObjectAssignment, ContactPerson, ContactCompany) by its id.
     *
     * @return $this
     */
     ...
     *
     * @param string $document_session_id Search by a specific document session id
     *
     * @return $this
     */
     ...
     * Gets term_fields
     *
     * @return \Swagger\Client\Model\DocumentSessionTermField[]
     */
     ...
     * Sets term_fields
     *
     * @param \Swagger\Client\Model\DocumentSessionTermField[] $term_fields Search for given text (Term) indicated by the fields in the TermFields list. Required in case 'Term' is given.
     *
     * @return $this
     */
