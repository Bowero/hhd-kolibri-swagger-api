 ...
 *
 * @category Class
 * @description Telerik internal use only.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExtensionInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ExtensionInfo';
     ...
     * Sets name
     *
     * @param string $name Telerik internal use only.
     *
     * @return $this
     */
     ...
     * Sets localized_name
     *
     * @param string $localized_name Telerik internal use only.
     *
     * @return $this
     */
