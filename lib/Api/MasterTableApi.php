...
/**
 * MasterTableApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class MasterTableApi
{
     ...
     */
    public function masterTableIndex($real_estate_agency_id, $culture = null)
    {
        list($response) = $this->masterTableIndexWithHttpInfo($real_estate_agency_id, $culture);
        return $response;
    }
     ...
     */
    public function masterTableIndexWithHttpInfo($real_estate_agency_id, $culture = null)
    {
        $returnType = '\Swagger\Client\Model\TableResponse';
        $request = $this->masterTableIndexRequest($real_estate_agency_id, $culture);
     ...
     */
    public function masterTableIndexAsync($real_estate_agency_id, $culture = null)
    {
        return $this->masterTableIndexAsyncWithHttpInfo($real_estate_agency_id, $culture)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function masterTableIndexAsyncWithHttpInfo($real_estate_agency_id, $culture = null)
    {
        $returnType = '\Swagger\Client\Model\TableResponse';
        $request = $this->masterTableIndexRequest($real_estate_agency_id, $culture);
     ...
     */
    protected function masterTableIndexRequest($real_estate_agency_id, $culture = null)
    {
